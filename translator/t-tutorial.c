...
/*
    ...
    wprintf("    Note that a linkage consists of a set of LINKS--a link being a
...
/*
    wprintf("    Before proceeding, it is necessary to manipulate the input linkset
...
/*
    wprintf("    II. WORD REPLACEMENT. The next step is to replace all the words
...
/*
    wprintf("    You will probably see that the translator did not initially choose
...
print_ending_blurb() {
/*
    wprintf("    Your sentence contained a 'attributive adjective' - an adjective
...
/*
    wprintf("    III. TRANSFORMATION. While some simple sentences can be translated
...
/*
    wprintf("    In some cases, other transformations are necessary. If the
...
/*
    wprintf("    The sentence you typed in contains the word 'and'. Sentences with
...
/*
    wprintf("    IV. WORD-POSITIONING. Once the transformations of the linkset are
...
/*
    wprintf("    At this point, the translator would normally replace all the
...
/*
    wprintf("    The translator would normally begin by generating a linkage for
...
/*
    wprintf("    At this point, the translator would normally turn the German
